          ...
          <div className="overflow-x-auto">
            <table className="w-full">              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="text-center py-3 px-4 font-medium text-gray-700 text-sm">Employee Code</th>
                  ...
                  paginatedEmployees?.map((employee) => {
                    ...
                    <tr key={employee?.id} className="hover:bg-gray-50">
                      ...
                      <td className="py-4 px-4 text-center">
                        <span className="text-gray-600 text-sm font-medium">{getDisplayEmployeeCode(employee)}</span>
                      </td>

                      {/* Created Date */}
                      <td className="py-4 px-4 text-center">
                        <span className="text-gray-600 text-sm">{formatDate(getJoiningDate(employee))}</span>
                      </td>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-teal-100 text-sm">
                      {selectedEmployee.firstName} {selectedEmployee.lastName} • {selectedEmployee.role}
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    ...
                    <span className="font-medium text-gray-900">{getDisplayEmployeeCode(selectedEmployee)}</span>
                  </div>
                  <div>
              ...
              <div>
                ...
                {selectedEmployee.permissions && selectedEmployee.permissions.length > 0 ? (
                        ...
                        <div className="bg-gray-50 px-4 py-3 border-b border-gray-200">
                          <div className="flex items-center justify-between">
                            <h4 className="font-medium text-gray-900 capitalize">
                              {permission.resource.replace(/([A-Z])/g, ' $1').trim()}
                            </h4>
                        ...
                        <div className="p-4">
                          <div className="flex flex-wrap gap-2">
                            {permission.actions && permission.actions.length > 0 ? (
                              ...
                              <span className="text-gray-500 text-sm">No actions defined</span>
                            )}
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 text-sm">No permissions assigned to this employee.</p>
                  </div>
                )}
              </div>
              ...
              {selectedEmployee.permissions && selectedEmployee.permissions.length > 0 && (
                <div className="mt-6 bg-blue-50 rounded-lg p-4">
                  ...
                  <div className="mt-2 text-sm text-blue-700">
                    <p>
                      This employee has access to <strong>{selectedEmployee.permissions.length}</strong> resource(s) 
                      with a total of <strong>{getPermissionCount(selectedEmployee.permissions)}</strong> action(s).
                    </p>
                  </div>
                </div>
              )}
