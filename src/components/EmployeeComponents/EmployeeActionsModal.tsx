      ...
      <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex border-b mb-4">
          <button
            ...
            className={`px-4 py-2 font-medium ${
              activeTab === 'actions'
                ? 'text-white border-b-2 border-[#043E49]'
                : ' text-[#043E49] hover:text-[#043E49] '
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full bg-[#043E49] text-white py-2 px-4 rounded-lg hover:bg-yellow-700 disabled:opacity-50 flex items-center justify-center"
              >
        ...
        {activeTab === 'stores' && (
          <div className="space-y-4">
            ...
            >
              {loading ? 'Updating...' : 'Update Store Assignments'}
            </button>
          </div>
        )}
              ...
              {permissions.map((perm, index) => (
                <div key={index} className="flex justify-between items-center bg-white border rounded p-3">
                  <div>
                    ...
                    <span className="text-blue-600">{perm.actions.join(', ')}</span>
                    <span className="text-gray-500 mx-2">•</span>
