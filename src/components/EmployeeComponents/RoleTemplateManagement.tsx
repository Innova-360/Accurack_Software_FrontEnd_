    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200">
      <div className="px-6 py-4 border-b border-gray-200">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-2xl font-bold text-[#043E49]">Role Templates</h2>
            <p className="text-gray-600 mt-1">Create and manage role templates for your employees</p>
          </div>
          <button
          ...
          {roleTemplates.map((template) => (
            <div key={template.id} className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow bg-white">
              <div className="flex justify-between items-start mb-4">
                <h3 className="font-semibold text-lg text-[#043E49]">{template.name}</h3>
              ...
              <div className="mb-4">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {template.permissions.slice(0, 3).map((perm, idx) => (
                    <span key={idx} className="bg-[#043E49] bg-opacity-10 text-[#043E49] px-2 py-1 rounded text-xs font-medium">
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xl font-bold text-[#043E49]">Assign Role Template</h3>
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-600"
          >
