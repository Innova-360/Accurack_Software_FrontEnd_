...
import Employee from "./Role.tsx";
import RoleForm from "./RoleForm.tsx";
import EmployeePermissionsModal from "./RolePermissionsModal.tsx";
import type { EmployeeAPIData } from "../../types/employee.ts";
...
const EmployeeManagement: React.FC<EmployeeManagementProps> = () => {
  ...
  const [viewPermissionsEmployee, setViewPermissionsEmployee] =
