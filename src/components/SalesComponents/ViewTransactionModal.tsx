...
const ViewTransactionModal: React.FC<ViewTransactionModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 backdrop-blur-[1px] z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md border-2 border-blue-500">
        <div className="p-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-sm font-semibold text-blue-600">{transaction.transactionId}</p>
              </div>
              <div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-900 font-medium">{transaction.customer}</p>
            </div>
            ...
            <div className="border-t pt-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-900">{formatCurrency(transaction.total - transaction.tax)}</p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-500">Tax</label>
                  <p className="text-sm text-gray-900">{formatCurrency(transaction.tax)}</p>
                </div>
              </div>
              <div className="mt-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <span className={`inline-block px-2 py-1 text-xs font-medium rounded mt-1 ${
                  transaction.payment === 'Cash' ? 'bg-green-50 text-green-700' :
                  transaction.payment === 'Card' ? 'bg-blue-50 text-blue-700' :
