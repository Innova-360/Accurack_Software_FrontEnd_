  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (onSupplierCreated) {
        ...
        // Handle nested data structure: result.supplier.data or result.supplier
        console.log("Full result:", result);
        let createdSupplierData = result?.supplier;

        // If supplier contains nested data, extract it
        if (
          createdSupplierData &&
          createdSupplierData.data &&
          typeof createdSupplierData.data === "object"
        ) {
          createdSupplierData = createdSupplierData.data;
        }

        // Fallback to original form data if extraction fails
        if (!createdSupplierData || !createdSupplierData.id) {
          createdSupplierData = supplierData;
        }
