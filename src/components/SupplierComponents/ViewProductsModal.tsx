      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-[#03414C]">Products Supplied</h2>
              <p className="text-sm text-gray-600">Products from {supplier.name}</p>
            </div>
          </div>
          <button
            onClick={onClose}
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">
                    {totalProducts > 0 ? formatCurrency(totalValue / totalProducts) : '$0.00'}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="p-6">
          {supplierProducts.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">This supplier hasn't provided any products yet.</p>
            </div>
          ) : (
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Product List ({totalProducts})</h3>
