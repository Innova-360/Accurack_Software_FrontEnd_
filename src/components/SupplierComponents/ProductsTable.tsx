    ...
    return (
      <div className="text-center py-16 bg-white">
        ...
        <p className="text-gray-600 mb-8 max-w-md mx-auto">
          {supplier.name} doesn't have any products in the system yet. Products will appear here once they're added.
        </p>
        <button
        ...
        {products.map((product, index) => (
          <div key={product.id} className="px-6 py-4 hover:bg-gray-50 transition-colors duration-150">
            <div className="grid grid-cols-12 gap-4 items-center">
              ...
              {/* SKU */}
              <div className="col-span-2">
                <span className="text-sm font-mono text-gray-900 bg-gray-100 px-2 py-1 rounded">{product.sku}</span>
              </div>
