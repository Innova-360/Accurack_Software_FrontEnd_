...
import { Permissions } from "../../components/RoleComponents";
...
const PermissionsPage: React.FC = () => {
  ...
  const handleEditEmployee = (employeeData: any) => {
    // Navigate to EditRolePage with the role data
    if (id) {
      navigate(`/store/${id}/edit-role`, {
        state: { employeeData, editMode: true },
      });
    } else {
      navigate("/edit-role", { state: { employeeData, editMode: true } });
    }
  };
