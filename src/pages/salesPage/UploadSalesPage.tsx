                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <button
                      ...
                      disabled={uploading}
                      className="px-8 py-3 bg-[#0f4d57] text-white rounded-lg hover:bg-[#0d3f47] transition-colors text-lg font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                    >
            ...
            <div className="mt-4 p-6 bg-gray-50 rounded-lg border-l-4 border-[#0f4d57]">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li>
                  ...
                  SKU, Category, Quantity, Price, Sale Date)
                </li>
                <li>
