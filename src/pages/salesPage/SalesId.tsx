        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            <nav className="flex gap-x-2 mb-6 items-center text-sm text-gray-500">
              <span className="hover:text-[#0f4d57] cursor-pointer transition-colors">
                Sales Orders
              </span>
              <ChevronRight size={16} className="text-gray-400" />
              <span className="text-[#0f4d57] font-medium">
                Order #{currentSale.id.slice(-8).toUpperCase()}
              </span>
            </nav>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 mb-6">
              <div className="flex justify-between items-start">
                ...
                <div
                  className={`inline-flex items-center gap-2 px-4 py-2 rounded-full border text-sm font-medium ${getStatusColor(currentSale.status)}`}
                >
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-mono text-gray-900">
                      {currentSale.userId.slice(-8).toUpperCase()}
                    </span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  <p className="leading-relaxed">
                    {currentSale.customer.customerAddress}
                  </p>
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span className="font-semibold text-green-600">
                    ${currentSale.allowance.toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                ...
                <div className="flex justify-between items-center py-3 border-b border-gray-100">
                  ...
                  <span className="font-mono text-sm text-gray-900">
                    {currentSale.storeId.slice(-8).toUpperCase()}
                  </span>
                </div>
                <div className="flex justify-between items-center py-3">
                  <span className="text-gray-600">Client ID</span>
                  <span className="font-mono text-sm text-gray-900">
                    {currentSale.clientId.slice(-8).toUpperCase()}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2">
                  ...
                  <span className="font-medium text-gray-900">
                    ${(currentSale.totalAmount - currentSale.tax).toFixed(2)}
                  </span>
                </div>
                <div className="flex justify-between items-center py-2">
                ...
                <div className="border-t border-gray-200 pt-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-[#0f4d57]">
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <span
                    className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(currentSale.status)}`}
                  >
                    {getStatusIcon(currentSale.status)}
                    {currentSale.status.toUpperCase()}
                  </span>
