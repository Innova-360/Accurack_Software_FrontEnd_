...
const PermissionsPage: React.FC = () => {
  ...
  const handleEditEmployee = (employeeData: any) => {
    ...
    if (id) {
      navigate(`/store/${id}/edit-employee`, { state: { employeeData, editMode: true } });
    } else {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="mt-[30px] mb-[15px] p-6">
        <div className="max-w-7xl mx-auto">
          ...
          <Permissions showHeader={false} onEditEmployee={handleEditEmployee} onAddEmployee={handleAddEmployee} />
        </div>
      </div>
    </div>
  );
