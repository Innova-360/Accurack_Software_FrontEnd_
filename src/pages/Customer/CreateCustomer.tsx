...
const CreateCustomer: React.FC = () => {
  ...
  const handleAddressChange = (field: keyof typeof addressFields, value: string) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!clientId) {
      toast.error("Client ID is required. Please wait for user data to load or log in again.");
      return;
    }
    ...
    try {
      ...
      toast.error(error || `Failed to ${isEditing ? 'update' : 'create'} customer`);
    }
  };
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              <div>
                ...
                />
                {formErrors.customerMail && (
                  <p className="mt-1 text-sm text-red-600">{formErrors.customerMail}</p>
                )}
              </div>
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
              ...
              <div>
                ...
                />
                {formErrors.telephoneNumber && (
                  <p className="mt-1 text-sm text-red-600">{formErrors.telephoneNumber}</p>
                )}
              </div>
              <div className="sm:col-span-2">
                ...
                {formErrors.customerAddress && (
                  <p className="mt-2 text-sm text-red-600">{formErrors.customerAddress}</p>
                )}
              </div>
            </div>
          </div>
