        ...
        <div className="overflow-x-auto border-[#E5E7EB] border-2 rounded-3xl">
          <div className="p-4 lg:p-8 flex flex-col md:flex-row gap-4 items-center">
            <div className="w-full md:w-1/2">
              <div className="relative">
                <img
                  src="/search.png"
                  alt=""
                  className="absolute top-1/2 left-[10px] transform -translate-y-1/2 w-5"
                />
                <input
                  type="text"
            ...
            <div className="w-full md:w-1/2 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-x-4 justify-end">
              ...
              <button
                className="w-full sm:w-auto bg-[#043E49] py-2 px-3 text-white rounded-xl pr-4 flex items-center justify-center gap-x-3"
                onClick={handleClick}
              >
                <Plus />
                Add New Tax
                ...
                {taxes.map((tax: TaxItem, idx: number) => (
                  <tr key={idx} className="hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3 whitespace-pre-line">
                      <span className="bg-[#E5E7EB] rounded-2xl py-1 px-2 text-xs">
                        Assigned to {tax.assignments}
                      </span>
                    </td>
                    <td className="px-4 py-3">
                      <div>{tax.date}</div>
