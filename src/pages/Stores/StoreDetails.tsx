        ...
        const fetchStore = async () => {
            ...
            try {
                ...
                const storeData = {
                    ...
                    enableNotifications: res.data.data.settings?.enableNotifications ?? true,
                };
                setForm(storeData);
                        ...
                        <div>
                            ...
                            <div className="border-b border-gray-200 pb-8 mb-8">
                                ...
                                <div className="flex items-center mb-6">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-[#03414C]">{store.name}</h3>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <p className="text-gray-900">
                                            {TIMEZONES.find(tz => tz.value === store.settings?.timezone)?.label || store.settings?.timezone}
                                        </p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">
                                        ...
                                        <p className="text-gray-900">
                                            {CURRENCIES.find(c => c.value === store.settings?.currency)?.label || store.settings?.currency}
                                        </p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">
                                        ...
                                        <p className="text-gray-900">{((store.settings?.taxRate ?? 0) * 100).toFixed(2)}%</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">
                                            Tax Mode
                                        </label>
                                        <p className="text-gray-900 capitalize">{store.settings?.taxMode}</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">
                                            Low Stock Alert
                                        </label>
                                        <p className="text-gray-900">{store.settings?.lowStockAlert}</p>
                                    </div>
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700 mb-1">
                                            Notifications
                                        </label>
                                        <p className="text-gray-900">{store.settings?.enableNotifications ? "Enabled" : "Disabled"}</p>
                                    </div>
                                </div>
                            </div>
